<!-- <div id="dsn_preloader" class="preloader">
        ...
        <div class="dsnload p-absolute">
            <span class="dsnload__row">
                <span class="dsnload__img">
                    <img src="assets/img/logo.png" class="logo-dark" alt="Sampoorn" decoding="async" loading="lazy">
                    <img src="assets/img/logo.png" class="logo-light" alt="Sampoorn" decoding="async" loading="lazy">
                </span>
            </span>
        ...
        <div class="logo-box v-middle">
            <h3 class="title text-upper">Sampoorn</h3>
        </div>
...
<header id="site_menu_header" class="site-header d-none">
    <div class="main-logo">
        <a href="index.php" data-dsn-text="Sampoorn" class="custom-logo-link main-brand effect-ajax" rel="home"
            aria-current="page">
            <img src="assets/img/logo.png" class="custom-logo logo-light" alt="Sampoorn">
            <img src="assets/img/logo.png" class="custom-logo logo-dark" alt="Sampoorn">
        </a>
    </div>
            ...
            <div class="nav__info">
                ...
                <div class="nav-content mt-30">
                    ...
                    <p class="links over-hidden mb-1">
                        <a class="link-hover d-block" href="tel:+919811913990"
                            data-hover-text="+919811913990">+91 9811913990 (Sumit)</a>
                        <a class="link-hover" href="tel:+91 9811912990" data-hover-text="+91 9811912990">+91 9811912990 (DN Aggarwal)</a>
                    </p>
                    <p class="links over-hidden"><a class="link-hover" href="mailto:sumit@sampoornmarketing.com"
                            data-hover-text="sumit@sampoornmarketing.com">sumit@sampoornmarketing.com</a></p>
