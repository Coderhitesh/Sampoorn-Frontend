                 ...
                 <div class="swiper swiper-container  h-100">
                     <div class="swiper-wrapper">
                             ...
                             <div class="slide-content p-absolute">
                                 <h2 class="title-lg has-box-mod p-relative">
                                     <a data-dsn-split="chars" class="effect-ajax text-upper"
                                         data-dsn-ajax="slider">From -25 to +45 <br> We Deliver
                                     </a>
                                 </h2>
                         ...
                         <div class="slide-item swiper-slide over-hidden">
                             ...
                             <div class="slide-content p-absolute">
                                 <h2 class="title-lg has-box-mod p-relative">
                                     <a data-dsn-split="chars" class="effect-ajax text-upper" data-dsn-ajax="slider">For Roadside to Poolside <br> We Deliver
                                     </a>
                                 </h2>
                         ...
                         <div class="slide-item swiper-slide over-hidden">
                             ...
                             <div class="slide-content p-absolute">
                                 <h2 class="title-lg has-box-mod p-relative">
                                     <a data-dsn-split="chars" class="effect-ajax text-upper" data-dsn-ajax="slider">For Brakes to Breakfast <br> We Deliver
                                     </a>
                                 </h2>
                         ...
                         <div class="slide-item swiper-slide over-hidden">
                             ...
                             <div class="slide-content p-absolute">
                                 <h2 class="title-lg has-box-mod p-relative">
                                     <a data-dsn-split="chars" class="effect-ajax text-upper"
                                         data-dsn-ajax="slider">Bridging Brands & <br> Bharat
                                     </a>
                                 </h2>
