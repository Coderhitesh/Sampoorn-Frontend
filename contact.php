    ...
    <main id="main_root" class="main-root">
        ...
        <div id="dsn-scrollbar">
            ...
            <div id="page_wrapper" class="wrapper hitesh-contact">
                    ...
                    <div class="p-relative contact-form over-hidden section-padding">
                        <div class="p-relative container ">
                            <div class="d-grid grid-md-2" data-dsn-gap="30px 30px">
                                <div class="box-info d-grid">
                                    <div class="box-title background-section has-border-radius p-relative over-hidden">
                                        ...
                                        <h2 class="title text-upper p-relative" style="color: white;">Let's Build Success Together</h2>
                                    </div>
                                    ...
                                    <div class="info background-section has-border-radius p-relative over-hidden">
                                        ...
                                        <div class="p-relative">
                                            <div class="mb-20">
                                                <h4 class="title-block mb-15" style="color: white;">Head Office</h4>
                                                <p style="color: white;">B-52, Sector 60, Noida,<br>UP – 201301</p>
                                            </div>

                                            <div class="mb-20" style="color: white;">
                                                <h4 class="title-block mb-15" style="color: white;">Branches</h4>
                                                <p style="color: white;">Noida (GSTN: 09ABKCS1075K1ZW)<br>Jammu (GSTN: 01ABKCS1075K1ZC)<br>Ladakh (GSTN: 38ABKCS1075K1ZV)</p>
                                            </div>

                                            <div class="mb-20">
                                                <h4 class="title-block mb-15" style="color: white;">Contact Information</h4>
                                                <p style="color: white;">Phone: <a href="tel:9811913990">9811913990 (Sumit)</a><br>
                                                    Phone: <a href="tel:9811912990">9811912990 (DN Aggarwal)</a><br>
                                                    Email: <a href="mailto:sumit@sampoornmarketing.com">sumit@sampoornmarketing.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <form id="contact-form" method="post" action="contact.php">
                                            <div class="form-row">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="form_name" name="name" class="form-control" placeholder="Enter your name" required>
                                                    <div class="error-message">Please enter your name</div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="form_email">Email Address</label>
                                                    <input type="email" id="form_email" name="email" class="form-control" placeholder="Enter your email" required>
                                                    <div class="error-message">Please enter a valid email address</div>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="form_inquiry">Inquiry Type</label>
                                                <select id="form_inquiry" name="inquiry_type" class="form-control" required>
                                                    <option value="" disabled selected>Select an inquiry type</option>
                                                    <option value="Brand">Brand</option>
                                                    <option value="Franchise">Franchise</option>
                                                    <option value="Career">Career</option>
                                                </select>
                                                <div class="error-message">Please select an inquiry type</div>
                                            </div>

                                            <div class="form-group">
                                                <label for="form_message">Your Message</label>
                                                <textarea id="form_message" name="message" class="form-control" rows="5" placeholder="Tell us about your inquiry..." required></textarea>
                            ...
                            <div class="social-box border-bottom border-top mt-30 d-flex align-items-center justify-content-center">
                                <p class="heading-color">Connect With Us</p>
                ...
                <!-- ========== Map  ========== -->
                <!-- <div class="map-custom hv-80" data-dsn-lat="28.597273" data-dsn-len="77.367277" data-dsn-zoom="14">
                </div> -->

                <iframe class="map-custom hv-80" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.916690006735!2d77.36101307522472!3d28.6022759854546!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce50fd3ea56db%3A0xbc069405e2f88235!2sSampoorn%20Marketing!5e0!3m2!1sen!2sin!4v1747481895582!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                <!-- ========== End Map  ========== -->
                ...
                <section class="next-page v-dark pt-section pb-50">
                    <div class="container">
                        <div class="tob-box d-flex justify-content-between align-items-end border-bottom pb-50 mb-50">
                            <h2 class="title text-upper">time to <br> connect! </h2>

                            <div class="dsn-btn dsn-btn-shape d-flex">

                                <a class="button background-main v-light effect-ajax" href="contact.php">
                                    <span class="title-btn p-relative  z-index-1 heading-color" data-animate-text="Get in Touch">
                        ...
                        <div class="bottom-box ">
                            <div class="d-flex gap-10 justify-content-between flex-wrap">
                                <div class="info-item">
                                    ...
                                    <a class="text-upper" href="mailto:sumit@sampoornmarketing.com">sumit@sampoornmarketing.com</a>
                                </div>

                                <div class="info-item">
                                    <h6 class="mb-10">Call Info</h6>
                                    <a class="text-upper" href="tel:9811913990">+91 9811913990</a>
                                </div>

                                <div class="info-item">
                                    <h6 class="mb-10">Head Office</h6>
                                    <span class="text-upper">Noida, UP</span>
                                </div>
                            </div>
