...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validateCheckboxGroups() {
        const checkboxGroups = [
            { name: 'associationRegisteredAs', message: 'Please select at least one registration type' },
            { name: 'memberOfAssociation', message: 'Please select at least one member type' },
            { name: 'typeOfBusinessAssociation', message: 'Please select at least one business type' }
        ];
