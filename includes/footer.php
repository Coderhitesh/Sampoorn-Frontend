        ...
        <div class="d-grid grid-lg-4 grid-md-3">
                ...
                <svg class="shape-one" width="30" height="30" viewbox="0 0 30 30" fill="none"
                    ...
                    <g clip-path="url(#clip0_13_104)">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M30 0H0C16.5684 0 30 13.4314 30 30V0Z" fill="#0E0E0E"></path>
                    </g>
                    <defs>
            ...
            <div class="footer-links">
                ...
                <ul>
                    ...
                    <li class="text-upper">
                        <a href="for-brand.php">For Brands</a>
                    </li>
                    <li class="text-upper">
                        <a href="distribution-franchise.php">Franchise</a>
                    </li>
                    <li class="text-upper">
    ...
    <div class="copyright background-main">
        <div class="container">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <p>© 2025 <a href="#">Sampoorn.</a> All rights reserved.</p>
