            ...
            <div class="hitesh-register-container" id="page_wrapper">
                <div class="hitesh-register-inner">
                    ...
                    <div class="hitesh-register-options">
                        <a href="distributor-register.php" class="hitesh-register-option">
                            <div class="hitesh-register-label">Distributor</div>
                        </a>
                        <a href="retailer-register.php" class="hitesh-register-option">
                            <div class="hitesh-register-label">Retailer</div>
                        </a>
                        <a href="association-register.php" class="hitesh-register-option">
                            <div class="hitesh-register-label">Association</div>
                        </a>
                    </div>
